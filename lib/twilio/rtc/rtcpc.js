...
RTCPC.prototype.create = function(rtcConstraints, rtcConfiguration, RTCPeerConnection) {
  this.log = Log.getInstance();
  this.pc = typeof RTCPeerConnection !== 'undefined'
    ? new RTCPeerConnection(rtcConfiguration, rtcConstraints)
    : new this.RTCPeerConnection(rtcConfiguration, rtcConstraints);
};
